...
<head>
    <meta charset="utf-8">
    <title>Do Micro Work - Forgot Password</title>
        ...
        <div class="container-fluid">
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <form action="{{ route('member_otp_verification') }}" method="post">
                        ...
                        <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                            <div class="text-center align-items-center justify-content-between mb-3">
                                <a href="{{ route('home') }}" class="">
                                    <h3 class="text-primary">Do Micro Work</h3>
                                    {{-- <p class="text-warning">Please check spam if you do not get mail in inbox..</p> --}}
                                </a>
                                <h3>Email</h3>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="email" name="email" class="form-control" id="floatingInput" placeholder="hello@example.com">
                                <label for="floatingInput">Provide the Email</label>
                                @error('email')
